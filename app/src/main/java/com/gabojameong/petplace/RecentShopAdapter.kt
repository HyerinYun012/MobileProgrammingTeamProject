...
class RecentShopAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        RecentShopViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_search_result, parent, false))

    override fun onBindViewHolder(holder: RecentShopViewHolder, position: Int) = holder.bind(shopList[position])
